...
class Converters {
    ...
    @TypeConverter
    fun fromDateTimestamp(value: Long): LocalDateTime = LocalDateTime.ofEpochSecond(value, 0, KST)

    @TypeConverter
    fun dateToDateTimestamp(time: LocalDateTime): Long = time.toEpochSecond(KST)
